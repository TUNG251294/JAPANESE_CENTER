  ...
  <main class="signup-form">
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6">
        <div class="card">
          <h3 class="card-header text-center">Update Teacher</h3>
          <div class="card-body">
            <form action="{{ route('update_teacher', $user->id) }}" method="POST">
              @csrf
    ...
    <div>
      <button type="button" class="btn btn-secondary" onclick="location.href='{{ route('teacher_list') }}'"><i
